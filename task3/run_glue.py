...
from torch.nn.parallel import DistributedDataParallel as DDP # Task 3
...
def train(args, train_dataset, model, tokenizer):
    ...
    # -------------------------------------------------
    # If you truly only run one epoch, you'll have:
    ...
    for epoch_idx, _ in enumerate(train_iterator):
        ...
        # Time each iteration, ignoring the first iteration later
        ...
        # Evaluate after this epoch (optional)
        evaluate(args, model, tokenizer, prefix=f"Epoch {epoch_idx}")
